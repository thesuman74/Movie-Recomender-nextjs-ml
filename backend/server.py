...
def process_frame(data):
    ...
    for (p, q, r, s) in faces:
        ...
        print(f"Prediction Label: {prediction_label}")  # Debug: Print the predicted label
    ...
    print(f"Stored emotion in session: {session.get('emotion_detected')}")  # Debug: Print session storage
...
def redirect_page():
    ...
    print(f"Redirecting based on emotion: {emotion}")  # Debug: Print the emotion used for redirection
    if emotion == 'happy':
